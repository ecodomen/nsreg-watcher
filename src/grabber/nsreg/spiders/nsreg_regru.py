...
class NsregRegruSpider(scrapy.Spider):
    ...
    def __init__(self, name=None, **kwargs):
        ...
        self.component = BaseSpiderComponent(
            ...
            regex=r"([0-9]+)[.,\s]?.*",
            path={
                'price_reg': '/html/body/div[1]/div/div[3]/article/div/div[2]/div[4]/div/table/tbody/tr[1]/td[2]/abbr/strong/text()',
                'price_prolong': '/html/body/div[1]/div/div[3]/article/div/div[2]/div[4]/div/table/tbody/tr[1]/td[2]/abbr/em/text()',
